...
# This might not be a 100% through check as atleast with PrimeNow/Wholefoods I have noticed that
# sometimes the page stops displaying this text after many refresh cycles and that is then 
# assumed to be a availability signal and a text is send.
# This is different thant the amazonPrimeNow.py that actually checks for a positive
...
class AutomateGroceryDelivery:
    def __init__(self):
        ...
        # You *can* put them directly here as well but that is **INSECURE**
        self.account_sid = os.environ['TWILIO_ACCOUNT_SID']
        self.auth_token = os.environ['TWILIO_AUTH_TOKEN']
        self.amazon_fresh_url = 'amazon fresh sign in page url here'
    ...
    def login(self, redirect = True):
        ...
        try:
            ...
            time.sleep(self.long_pause) # allow time for user to enter captcha
            self.login(False)
        except: # handle OTP
